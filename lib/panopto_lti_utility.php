...
class panopto_lti_utility {
     ...
     */ 
    public static function panoptocourseembed_get_course_tool_id($courseid) {
        global $DB;
     ...
     */ 
    public static function panoptocourseembed_get_course_tool_url($courseid) {
        global $DB;
        require_once(dirname(dirname(dirname(dirname(__FILE__)))) . '/mod/lti/locallib.php');
     ...
     */
    public static function panoptocourseembed_launch_tool($instance) {
        list($endpoint, $params) = panopto_lti_utility::panoptocourseembed_get_launch_data($instance);
     ...
     * @since  Moodle 3.0
     */
    private static function panoptocourseembed_get_launch_data($instance, $nonce = '') {
    ...
    public static function panoptocourseembed_is_active_user_enrolled($targetcontext) {
        global $USER; 
