...
Feature: set panoptocourseembed idnumber
  In order to set panoptocourseembed idnumber
  As a teacher
  I should create panoptocourseembed activity and set an ID number
  ...
  Scenario: panoptocourseembed ID number input box should be shown.
    ...
    When I add a "panoptocourseembed" to section "1" and I fill the form with:
      | Panoptocourseembed text | Panoptocourseembed with ID number set |
      | Availability | Show on course page |
      | ID number | C1PANOPTOCOURSEEMBED1 |
